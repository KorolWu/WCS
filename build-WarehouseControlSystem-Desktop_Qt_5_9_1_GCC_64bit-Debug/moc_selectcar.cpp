/****************************************************************************
** Meta object code from reading C++ file 'selectcar.h'
**
...
#include "../WarehouseControlSystem/ControlClass/selectcar.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'selectcar.h' doesn't include <QObject>."
...
const QMetaObject SelectCar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SelectCar.data,
      qt_meta_data_SelectCar,  qt_static_metacall, nullptr, nullptr}
};
...
void *SelectCar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectCar.stringdata0))
        return static_cast<void*>(const_cast< SelectCar*>(this));
